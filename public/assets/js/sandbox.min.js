...
SANDBOX.core.selectors = {
    "version-selector": {},
    "theme-selector": {noneSelectedText: "<b>Theme</b>", size: "auto"}
};
...
SANDBOX.core.setup = function() {
    ...
    var editor = SANDBOX.utils.initEditor(SANDBOX.core.theme);
    
    editor = SANDBOX.core.themeSettings();
    ...
    $('#theme-selector').change(function() {
        $.get('/forget-theme-settings');
        SANDBOX.core.theme = $(this).find(":selected").val();
        SANDBOX.core.themeSettings();
    });
